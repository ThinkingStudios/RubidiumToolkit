...
public final class DynamicLightHandlers {
    ...
    public static void registerDefaultHandlers() {
        ...
        registerDynamicLightHandler(EntityType.ITEM, entity -> DynamicLightsFeatures.getLuminanceFromItemStack(entity.getItem(), entity.isUnderWater()));
        registerDynamicLightHandler(EntityType.ITEM_FRAME, entity -> {
            World world = entity.getCommandSenderWorld();
            return DynamicLightsFeatures.getLuminanceFromItemStack(entity.getItem(), !world.getFluidState(entity.blockPosition()).isEmpty());
        });
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T extends TileEntity> @Nullable DynamicLightHandler<T> getDynamicLightHandler(@NotNull TileEntityType<T> type) {
