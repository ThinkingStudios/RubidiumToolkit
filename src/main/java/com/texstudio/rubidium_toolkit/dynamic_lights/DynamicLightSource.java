...
public interface DynamicLightSource {
    ...
    {
        return RubidiumDynamicLights.isEnabled() && RubidiumDynamicLights.containsLightSource(this);
    }
    ...
    default void setDynamicLightEnabled(boolean enabled) {
        ...
        if (enabled)
            RubidiumDynamicLights.addLightSource(this);
        else
            RubidiumDynamicLights.removeLightSource(this);
    }
