package com.texstudio.rubidium_toolkit.features.DynamicLights.api;
...
public final class DynamicLightHandlers
{
    ...
    public static void registerDefaultHandlers()
    {
        ...
        registerDynamicLightHandler(EntityType.ITEM_FRAME, entity -> {
            ...
            return DynamicLightsFeature.getLuminanceFromItemStack(entity.getItem(), !world.getFluidState(entity.blockPosition()).isEmpty());
        });
